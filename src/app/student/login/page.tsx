...
import { Users, Mail, ArrowLeft, Loader2, ArrowRight } from 'lucide-react';
...
export default function StudentLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!email.trim()) {
      showToast('Email Required', 'Please enter your registered student email address.', 'error');
      return;
    }
    ...
    if (res.success && res.role === 'student') {
      showToast('Welcome!', 'Entering Sangam Student Portal...', 'success');
      router.push('/student');
      ...
      showToast('Not Found', res.message || 'No student account registered with this email.', 'error');
    }
  };
      ...
      <Card className="w-full max-w-md p-8 bg-white border border-neutral-200/80 shadow-lg rounded-2xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-neutral-500">
            Access your team roster, announcements, Sangam documents, and live camera snap.
          </p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <Input
                ...
                placeholder="e.g. alex.chen@student.sangam.edu"
        ...
        <div className="pt-3 border-t border-neutral-100 space-y-2">
          ...
          <button
            type="button"
            onClick={() => setEmail('abhi31mahi@gmail.com')}
          ...
          >
            <div>
              <div className="text-[11px] font-bold text-neutral-800">ABHI</div>
              <div className="text-[10px] text-neutral-500">abhi31mahi@gmail.com</div>
            </div>
